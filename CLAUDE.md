...
- **Секреты:** системного keyring нет и не будет. API-ключи хранятся в `secrets.json` с правами 0600. Это осознанное решение — НЕ помечать как баг или уязвимость при аудите
